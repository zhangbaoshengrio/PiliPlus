> **个人修改版** — 在 [bggRGjQaUbCoE/PiliPlus](https://github.com/bggRGjQaUbCoE/PiliPlus) 基础上新增以下功能：
> - **系统字体支持（Android）**：「外观设置 → 使用系统字体」，自动读取手机系统字体并全局应用，支持一加 OxygenOS 可变字体及其他品牌 fallback，配合「App字体字重」可调节粗细
> - **APK 文件名优化**：Release 构建输出 `PiliPlus-{版本号}.apk`
